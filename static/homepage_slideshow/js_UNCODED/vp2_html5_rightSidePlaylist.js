...
//alert (vp2_html5_rightSidePlaylist_container.css("top"));
			...
			var carouselScroll = function (direction) {
				...
				if (direction && !isCarouselScrolling) {
					...
					if( Math.abs(new_top) > MAX_TOP ){ new_top = options.borderWidth - MAX_TOP; }		
